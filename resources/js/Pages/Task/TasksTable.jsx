        ...
        <>
            ...
            <div className="overflow-auto">
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-500 dark:bg-gray700 dark:text-gray-400 border-b-2 border-gray-400">
                    ...
                    <tbody>
                        {tasks.data.map(task => (
                            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700" key={task.id}>
                                ...
                                <td className="px-3 py-2">
                                    <Link href={route("task.show", task.id)} className="px-3 py-2 text-gray-100 hover:underline">{task.name}</Link>
                                </td>
                                <td className="px-3 py-2">
                                    <span className={
